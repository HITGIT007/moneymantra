...
const DateRangeModal = ({ showModal, handleFilterToggle, startDate, setStartDate, endDate, setEndDate }) => {
  return (
    <Modal show={showModal} onHide={handleFilterToggle}>
      ...
      <Modal.Footer>
        <Button variant="secondary" onClick={() => { setStartDate(""); setEndDate(""); handleFilterToggle(); }}>Close</Button>
        <Button variant="primary" onClick={handleFilterToggle}>Apply</Button>
      </Modal.Footer>
    </Modal>
  );
};
